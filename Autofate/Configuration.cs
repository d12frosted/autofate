...
public sealed class Configuration
{
    ...
    /// </summary>
    public int ZoneDwellSeconds = 720;
    ...
    public bool SharedFateEW = false;
    /// <summary>Include Dawntrail zones in Shared FATEs mode.</summary>
    public bool SharedFateDT = false;
    ...
    /// <summary>
    /// Leveling mode: cap the FATE zone selection at this level. We farm in the best zone for
    /// min(playerLevel, this cap), so the bot stays in (e.g.) the level-50 zone even past 50.
    /// Stopping is handled separately by the Stop Triggers tab (DesiredLevel/StopAtLevel).
    /// </summary>
    public int LevelingZoneCap = 100;
    public bool StopAtGemstoneCount = false;
    public int GemstoneStopCount = 50000;
    ...
    public int HealerStanceHpThreshold = 70; // % HP to switch to healer
    public bool AutoGysahlGreens = true;
    public int GysahlReuseSeconds = 15; // re-summon when companion timer below this

    // Chocobo leveling
    public bool ChocoboLevelingEnabled = true;
    ...
    public int ConsumableReuseSeconds = 20;

    // ------------------------------------------------------------------ Repair
    public bool AutoRepair = true;
    public int RepairThresholdPercent = 15;
